...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_2_change_language.setIcon(icon3)
        ...
        self.pushButton_Change_lang.setIcon(icon3)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/icon/icon/search-13-48.ico", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/icon/icon/user-48.ico", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.gridLayout_4 = QGridLayout(self.upload_page)
        self.gridLayout_4.setObjectName(u"gridLayout_4")
        self.widget_for_scroll = QWidget(self.upload_page)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 45, 16))
        ...
        self.widget_upload = QWidget(self.upload_page)
        ...
        self.widget = QWidget(self.upload_page)
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, 0, 535, 148))

...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icon/icon/activity-feed-32.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.others_btn_1 = QtWidgets.QPushButton(self.icon_only_widget)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icon/icon/home-4-32.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.others_btn_2 = QtWidgets.QPushButton(self.full_menu_widget)
        ...
        spacerItem5 = QtWidgets.QSpacerItem(20, 413, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        self.exit_btn_1.toggled['bool'].connect(self.exit_btn_2.setChecked)
        self.exit_btn_2.toggled['bool'].connect(self.exit_btn_1.setChecked)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_10.setText(_translate("MainWindow", "Userpage"))

...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout_12 = QtWidgets.QHBoxLayout(self.show_result_widget)
        self.horizontalLayout_12.setObjectName("horizontalLayout_12")
        self.plainTextEdit = QtWidgets.QPlainTextEdit(self.show_result_widget)
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 750, 148))
        ...
        self.radioButton = QtWidgets.QRadioButton(self.widget_upload_edit)
        self.radioButton.setObjectName("radioButton")
        self.horizontalLayout_9.addWidget(self.radioButton)
        self.radioButton_2 = QtWidgets.QRadioButton(self.widget_upload_edit)
        self.radioButton_2.setObjectName("radioButton_2")
        self.horizontalLayout_9.addWidget(self.radioButton_2)
        self.verticalLayout_8.addLayout(self.horizontalLayout_9)
        self.horizontalLayout_10 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_10.setObjectName("horizontalLayout_10")
        self.radioButton_4 = QtWidgets.QRadioButton(self.widget_upload_edit)
        self.radioButton_4.setObjectName("radioButton_4")
        self.horizontalLayout_10.addWidget(self.radioButton_4)
        self.radioButton_3 = QtWidgets.QRadioButton(self.widget_upload_edit)
        ...
        self.label_2 = QtWidgets.QLabel(self.widget_upload_edit)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_2.setFont(font)
        self.label_2.setObjectName("label_2")
        self.horizontalLayout_6.addWidget(self.label_2)
        self.lineEdit_2 = QtWidgets.QLineEdit(self.widget_upload_edit)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.pushButton_2 = QtWidgets.QPushButton(self.widget_upload_edit)
        font = QtGui.QFont()
        ...
        spacerItem5 = QtWidgets.QSpacerItem(307, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        self.pushButton_4 = QtWidgets.QPushButton(self.widget_actions)
        font = QtGui.QFont()
        font.setFamily("Poppins")
        font.setPointSize(14)
        ...
        self.pushButton_5 = QtWidgets.QPushButton(self.widget_actions)
        font = QtGui.QFont()
        font.setFamily("Poppins")
        font.setPointSize(14)
        self.pushButton_5.setFont(font)
        self.pushButton_5.setStyleSheet("background-color:rgb(255, 79, 132)")
        ...
        self.search_widget.setMinimumSize(QtCore.QSize(0, 100))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioButton.setText(_translate("MainWindow", "Replace Old Doc file And Add new Doc file"))
        self.radioButton_2.setText(_translate("MainWindow", "Add new images to the same old doc file"))
        self.radioButton_4.setText(_translate("MainWindow", "Do not chnage the file name"))
        self.radioButton_3.setText(_translate("MainWindow", "Change file name"))

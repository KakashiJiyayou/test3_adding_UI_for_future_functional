...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollarea_checkbox_dirlist = QtWidgets.QVBoxLayout()
        self.scrollarea_checkbox_dirlist.setSpacing(0)
        self.scrollarea_checkbox_dirlist.setObjectName("scrollarea_checkbox_dirlist")
        ...
        self.pushButton_2.clicked['bool'].connect(self.pushButton_3.setChecked) # type: ignore
        self.pushButton_3.clicked['bool'].connect(self.pushButton_2.setChecked) # type: ignore

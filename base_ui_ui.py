...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_new_doc_name = QLabel(self.widget_upload)
        self.label_new_doc_name.setObjectName(u"label_new_doc_name")
        font2 = QFont()
        font2.setPointSize(12)
        self.label_new_doc_name.setFont(font2)

        self.horizontalLayout_5.addWidget(self.label_new_doc_name)

        self.lineEdit_new_doc_name = QLineEdit(self.widget_upload)
        self.lineEdit_new_doc_name.setObjectName(u"lineEdit_new_doc_name")
        self.lineEdit_new_doc_name.setFont(font2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_new_doc_name.setText(QCoreApplication.translate("MainWindow", u"Name \"\u65b0\u6587\u4ef6", None))
        self.lineEdit_new_doc_name.setPlaceholderText(QCoreApplication.translate("MainWindow", u"\u5168\u65b0\u6587\u4ef6Give a name ....", None))
